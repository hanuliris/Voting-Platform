...
To ensure data integrity and prevent duplicate voting

To demonstrate real-world implementation of DBMS concepts
...
Backend: (Add if applicable – PHP / Node.js / Python, etc.)
...
git clone git@github.com:hanuliris/Voting-Platform.git
...
Understanding of database relationships and queries

Secure data handling in sensitive applications
